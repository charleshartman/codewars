...
# => NO. Vasya will not have the right bills to give 75 dollars of change
# (you can't make two bills of 25 from one of 50)

=begin
if 25 yes
  if register.any?(25)
if 50 and 25 is in array yes
if 100 and 3 25 or 1 25 and 1 50 yes

create new array (register)
iterate with .shift and evaluate by looking at two arrays
